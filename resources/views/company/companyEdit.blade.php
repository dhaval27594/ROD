                                                        ...
                                                        <div class="col-md-7 col-sm-7 col-xs-7 col-lg-7">
                                                            <div class="search-category-container">
                                                                <select id="location" name="location" class="form-control dropdown-product selectpicker">
                                                                    ...
                                                                    <option value="Cota D'Ivoire" @if($companydetail->location=='Cota D'Ivoire')selected="selected"@endif>Cote d'Ivoire</option>
                                                                    ...
                                                                    <option value="Democratic People's Republic of Korea" @if($companydetail->location=='Democratic People's Republic of Korea')selected="selected"@endif>Korea, Democratic People's Republic of</option>
